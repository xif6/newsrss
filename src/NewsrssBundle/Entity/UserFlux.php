 ...
 * )
 * @ORM\Entity(repositoryClass="NewsrssBundle\Entity\UserFluxRepository")
 */
class UserFlux
{
    /**
     ...
     * Set user
     *
     * @param \NewsrssBundle\Entity\User $user
     * @return UserFlux
     */
    public function setUser(\NewsrssBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \NewsrssBundle\Entity\User
     */
     ...
     * @return UserFlux
     */
    public function setFlux(\NewsrssBundle\Entity\Flux $flux = null)
    {
        $this->flux = $flux;
     ...
     * Get flux
     *
     * @return \NewsrssBundle\Entity\Flux
     */
